...
const set2english = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner"
			style="background-image: url(images/0466-SS-ProductionPlanning_Gant_tcm27-35062.jpg);" data-stellar-background-ratio="0.5">
		...
		<h2>Part M: Essentials
			</h2>
			<div class="b-game-card__cover" style="background-image: url(images/Continuing-Airworthiness-3.png);">

			</div>
		</div>

		<div class="b-game-card">
		<h2>Part CAMO: Essentials
			</h2>
			<div class="b-game-card__cover" style="background-image: url(images/1696850381569.jpeg);">
		...
		<h2>ETOPS TRAINING
			...
			<div class="b-game-card__cover" style="background-image: url(images/oijhv.png);">

			</div>
		</div>

		<div class="b-game-card">
		<h2>Part 145: Production Planning
			</h2>
			<div class="b-game-card__cover" style="background-image: url('images/aaa8.jpg');">
...
const set2french = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(&quot;images/0466-SS-ProductionPlanning_Gant_tcm27-35062.jpg&quot;); height: 730px; background-position: 0px -300px;" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="display-t js-fullheight" style="height: 730px;">
							<div class="display-tc js-fullheight animate-box fadeIn animated-fast" data-animate-effect="fadeIn" style="height: 730px;">
								<h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">	AUTRES FORMATIONS
								</font></font></h1>
		...
		<div class="l-container">
		<div class="b-game-card">
		<h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Partie M&nbsp;:&nbsp;essentiels
			</font></font></h2>
			<div class="b-game-card__cover" style="background-image: url(images/Continuing-Airworthiness-3.png);">
		...
		<div class="b-game-card">
		<h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Partie CAMO&nbsp;:&nbsp;les essentiels
			</font></font></h2>
			<div class="b-game-card__cover" style="background-image: url(images/1696850381569.jpeg);">
		...
		<div class="b-game-card">
		<h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Partie 145 : Planification de la production
			</font></font></h2>
			<div class="b-game-card__cover" style="background-image: url('images/aaa8.jpg');">
