...
const set2english = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner"
			style="background-image: url(images/Training-on-Electronic-Records-Management.png);" data-stellar-background-ratio="0.5">
		...
		<div  class="slideshow-container">
			<div class="mySlides1">
			<p>Complete and accurate records are the key to a perfect asset. Not only for the value of your aircraft, or the re-marketing but also during the operations to be sure that the aircraft is completely and correctly maintained and managed.
			...
			<span>
				...
				<img src="images/aaa18.jpg" style="width:100%;height:80vh;">
			</div>

			<div class="mySlides1">
			<p>Our experts are constantly in the field and on top of aircraft records, legislation, and maintenance. They know where to look for and assess the quality of records and advice the next steps.
			...
			<span>
				...
				<img src="images/aaa2.jpg" style="width:100%;height:80vh;">
			</div>

			<div class="mySlides1">
			<p>  Timing is important. You don’t want to experience issues on a re-delivery that stalls the whole process. That is the reason why our consultants are able to do a record inspection during the lease term and even archive it for you including a valuation of the records. That means that you already have a clear insight into the quality of the records, and you can even do a well-substantiated risk assessment during the lease term.
...
const set2french = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(&quot;images/Training-on-Electronic-Records-Management.png&quot;); height: 730px; background-position: 0px -478px;" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="display-t js-fullheight" style="height: 730px;">
							<div class="display-tc js-fullheight animate-box fadeIn animated-fast" data-animate-effect="fadeIn" style="height: 730px;">
								<h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">LA GESTION DES DOSSIERS</font></font></h1>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="slideshow-container">
			...
			<p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nos experts sont constamment sur le terrain et au courant des dossiers, de la législation et de la maintenance des avions. Ils savent où chercher et évaluent la qualité des dossiers et conseillent les prochaines étapes.
			...
			<div class="mySlides1" style="display: none;">
			<p><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">  Le timing est important. Vous ne voulez pas rencontrer de problèmes lors d’une nouvelle livraison qui bloquent l’ensemble du processus. C'est la raison pour laquelle nos consultants sont en mesure de procéder à une inspection des dossiers pendant la durée du bail et même de les archiver pour vous, y compris une évaluation des dossiers. Cela signifie que vous avez déjà un aperçu clair de la qualité des enregistrements et que vous pouvez même procéder à une évaluation des risques bien étayée pendant la durée du bail.
