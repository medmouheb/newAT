...
const set2english = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner"
			style="background-image: url(images/bg-contact-us.png);" data-stellar-background-ratio="0.5">
...
const set2french = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(&quot;images/bg-contact-us.png&quot;); height: 730px; background-position: 0px 0px;" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
