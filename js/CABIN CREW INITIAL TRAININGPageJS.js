			...
			<div id="fh5co-featured-menu ">
				...
				<div class="newList">
					<div class="row">
						...
						height: 61vh;
					" class="col-md-6">
							<h2 style="color: white; font-size: xxx-large;"><boild>LITHUANIA, Vilnius</boild></h2>
							<ul>
								<li><strong>5 min</strong> drive from the Vilnius International airport</li>
								<li><strong>4 FFSs for your services:</strong> two A320, B737 NG and B737 CL</li>
								<li>Spacious classrooms, briefing/debriefing rooms</li>
								<li>A dining room and a leisure zone with snack and coffee vending machines</li>
								<li>Accommodation offered at 4* LOOP Hotel next to the training center</li>
						...
						<div style="padding: 0px;" class="col-md-6">
							<div class="slideshow-container">
								...
								<div class="mySlides1">
									...
									<img src="images/infra-slider-4.webp"
