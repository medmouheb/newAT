...
const set2english = () => {
	...
	<!-- </div> -->
			...
			<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner"
				style="background-image: url(images/cabin-crew-courses-and-training-institure.jpg);"
...
const set2french = () => {
    document.getElementById("mainContent").innerHTML = `
		...
		<!-- </div> -->
			...
			<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(&quot;images/cabin-crew-courses-and-training-institure.jpg&quot;); height: 713px; background-position: 0px 0px;" data-stellar-background-ratio="0.5">
				<div class="overlay"></div>
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center">
							<div class="display-t js-fullheight" style="height: 713px;">
								<div class="display-tc js-fullheight animate-box fadeIn animated-fast" data-animate-effect="fadeIn" style="height: 713px;">
									<h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">FORMATION DE L'ÉQUIPAGE DE CABINE</font></font></h1>
