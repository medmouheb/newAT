...
const set2english = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner"
			style="background-image: url(images/images.avif);" data-stellar-background-ratio="0.5">
		...
		<div class="fh5co-section animate-box"
			>
			<div class="overlay"></div>

				<div style="background-image: url('images/aaa5.jpg');
				background-repeat: no-repeat;
				background-size: 100%;    background-position-y: 40%;

				padding: 12%;" class="  text-center fh5co-heading">
						<p style="font-family: trajan-pro-3,serif !important; font-size: x-large;    color: white !important;						"   >You probably experienced it before, <span style="color : #bd9973" > new opportunities</span>  for the company,<span style="color : #bd9973" >base maintenance</span>  projects, new legislation, projects that come and go. But who can do the job? Everybody is busy doing his own job and managing the daily operations. Our Engineering professionals have a lot of experience in managing projects. From introducing a new type of operation like ETOPS or managing the base maintenance activities.</p>
				</div>
		</div>
...
const set2french = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(&quot;images/images.avif&quot;); height: 730px; background-position: 0px 0px;" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<div class="display-t js-fullheight" style="height: 730px;">
							<div class="display-tc js-fullheight animate-box fadeIn animated-fast" data-animate-effect="fadeIn" style="height: 730px;">
								<h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">GESTION DE PROJET</font></font></h1>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="fh5co-section animate-box fadeInUp animated-fast">
			<div class="overlay"></div>
				...
				padding: 12%;" class="  text-center fh5co-heading">
						<p style="font-family: trajan-pro-3,serif !important; font-size: x-large;    color: white !important;						"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Vous en avez probablement déjà fait l'expérience, </font></font><span style="color : #bd9973"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">de nouvelles opportunités</font></font></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">   pour l'entreprise, des projets </font></font><span style="color : #bd9973"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">de maintenance des bases</font></font></span><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">   , des nouvelles législations, des projets qui vont et viennent. Mais qui peut faire le travail ? Chacun est occupé à faire son propre travail et à gérer les opérations quotidiennes. Nos professionnels en ingénierie ont beaucoup d’expérience dans la gestion de projets. De l'introduction d'un nouveau type d'opération comme ETOPS à la gestion des activités de maintenance de la base.</font></font></p>
				</div>
		</div>
