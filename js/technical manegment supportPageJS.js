...
const set2english = () => {
	...
	<!-- </div> -->
		...
		style="background-image: url(images/Technical-Tech-Support-Screen.webp);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight">
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							<h1> Technical Management Support</h1>
						</div>
					</div>
				</div>
			</div>
        ...
        <ul class="cards">
            ...
            <li class="cards__item">
                <div class="card">
                    ...
                    <div class="card__content">
                        <div class="card__title">TRAINING & ORGANISATIONAL SUPPORT
						</div>
                        <p id="text2"  class="card__text">The Limitless team of consultants has years of experience in aviation. Constantly being active in CAMOs and MROs keeps the whole team up to date and keeps up their knowledge. They are highly motivated in sharing their knowledge with other professionals in aviation.
            ...
            <li class="cards__item">
                <div class="card">
                    ...
                    <div class="card__content">
                        <div class="card__title">BASE MAINTENANCE REPRESENTATIVE

						</div>
                        <p  id="text3" class="card__text">Our technical representatives have years of experience with operators and MROs. Hence, we know what it takes to make a base maintenance visit successful. This means, being on time, high quality, and within budget. Our professionals are there to guide you through this complex task.
						</p>
                    </div>
                </div>
            </li>
...
const set2french = () => {
	...
	<!-- </div> -->
		...
		<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url(&quot;images/Technical-Tech-Support-Screen.webp&quot;); height: 730px; " data-stellar-background-ratio="0.5">
		<div class="overlay"></div>
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="display-t js-fullheight" style="height: 730px;">
						<div class="display-tc js-fullheight animate-box fadeIn animated-fast" data-animate-effect="fadeIn" style="height: 730px;">
							<h1><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Assistance à la gestion technique</font></font></h1>
						</div>
					</div>
				</div>
			</div>
        ...
        <ul class="cards">
            <li class="cards__item">
                <div class="card">
                    <div class="card__image card__image--fence"></div>
                    <div class="card__content">
                        <div class="card__title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">SUPPORT TECHNIQUE
            ...
            <li class="cards__item">
                <div class="card">
                    <div class="card__image card__image--river"></div>
                    <div class="card__content">
                        <div class="card__title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">FORMATION &amp; SOUTIEN ORGANISATIONNEL
						</font></font></div>
            ...
            <li class="cards__item">
                <div class="card">
                    <div class="card__image card__image--record"></div>
                    <div class="card__content">
                        <div class="card__title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">REPRÉSENTANT DE L'ENTRETIEN DE LA BASE
